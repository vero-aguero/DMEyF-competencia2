...
# Se tomó el segundo mejor resultado del BO, tomando como referencia el gráfico para ver como se comporta el modelo para enero
...
PARAM$finalmodel$learning_rate     <- 0.00500244938678657
PARAM$finalmodel$num_iterations    <- 926
PARAM$finalmodel$num_leaves        <- 234
PARAM$finalmodel$min_data_in_leaf  <- 1721 
PARAM$finalmodel$feature_fraction  <- 0.242688769836711
